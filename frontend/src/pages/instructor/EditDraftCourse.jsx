...
function EditDraftCourse() {
  ...
  useEffect(() => {
    const fetchCourse = async () => {
      ...
      console.log("Fetched Course Data:", tempCourse);
    };
    fetchCourse();
  }, []);
  ...
  const handleStepOne = async (e) => {
    ...
    const response = await axios.post(
      `${import.meta.env.VITE_API_URL}/api/instructor/update-drafted-course/${id}`,
      {
  ...
  const handleStepTwo = async (e) => {
    ...
    console.log(tempCourse.id);
    const response = await axios.post(
      `${import.meta.env.VITE_API_URL}/api/instructor/course-tags`,
      {
