      ...
      <div className="relative flex items-center justify-center">
        ...
        {isAuthenticated ? (
          <Link
            style={{ fontSize: "13px" }}
            to={"/explore"}
            className="relative z-10 px-3 py-2 text-white text-[10px] font-semibold rounded-lg bg-white/10 backdrop-blur-md border border-white/20 hover:bg-white/20 transition"
          >
            Get Started
          </Link>
        ) : (
